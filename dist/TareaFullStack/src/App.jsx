...
function App() {
  ...
  const loginForm = () => (
    ...
    <div className="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
      <h1 className="title-font font-medium text-3xl text-gray-900">Mi Tienda Tec</h1>
      <p className="leading-relaxed mt-4">Inicia sesion para ver los increibles productos que tenemos para ti!</p>
    </div>
